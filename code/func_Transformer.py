...
def Transformer(sequence_np, label_np, number_of_tactical_action, dim_of_image, test, make_graph, val):
    ...
    classifier = tisc.build_classifier(model_name="Transformer",
                                    ...
                                    num_classes=dim_of_image,
                                    class_labels=number_of_tactical_action)
