...
def choice_data(competition_name, sequence_np, label_np, sequence_data, label_data, grid_size_y, grid_size_x, data_length, num_player, num_tactical_action, tactical_action_label, tactical_action_name_list):
    ...
    for i in range(label_np.shape[0]):
        ...
        if label_np[i, tactical_action_label] != -1.0:
